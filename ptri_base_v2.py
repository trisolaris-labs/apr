...
from utils.fees import getAccount, getFundedAccount, convertStablestoLPV2
from utils.node import w3, init_erc20, init_stablelp_maker_v2
...
def ptri_base_v2(timestamp):
    ...
    stable_lp_maker_v2 = init_stablelp_maker_v2()
    ...
    # Stable LP Maker V2 Operations
    tlp_amount += convertStablestoLPV2(stable_lp_maker_v2, w3, acct)
